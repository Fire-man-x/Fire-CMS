...
CREATE TABLE `firecms_settingDescriptions` (
	...
	CONSTRAINT `settingDescriptions_ibfk_1` FOREIGN KEY (`settingId`) REFERENCES `firecms_settings` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT `settingDescriptions_ibfk_2` FOREIGN KEY (`languageId`) REFERENCES `firecms_languages` (`languageId`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;


INSERT INTO `firecms_settings` (`id`, `imageResolution`, `themePath`) VALUES
	(1,	'1000x1000',	'default');
